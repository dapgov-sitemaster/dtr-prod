<x-mail::message>
# Good day {{ $employee->first_name .' '.$employee->last_name }}!

We would like to notify you that our eDTR system has recorded a change in your official working hours, effective from **{{ $data->created_at->format('F d, Y') }}**.
