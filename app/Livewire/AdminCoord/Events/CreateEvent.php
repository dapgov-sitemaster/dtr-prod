                ...
                Forms\Components\Grid::make()
                    ->schema([
                            ...
                            ->options(function () {
                                ...
                                foreach (Events::cases() as $case) {
                                    if ($case == Events::WFH || $case == Events::HWFH) {
                                        if ($this->eventData->date->dayOfWeek != Carbon::MONDAY) {
                        ...
                        \Filament\Forms\Components\Select::make('hris_number')
                            ...
                            ->getSearchResultsUsing(fn(string $search): array => Employee::searchEmployee($search)->departmentCovered()->isScheduled($this->eventData->date->format('Y-m-d'))->limit(10)->get()->pluck('full_name', 'hris_number')->toArray())
